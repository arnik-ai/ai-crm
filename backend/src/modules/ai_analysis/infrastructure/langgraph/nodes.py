...
def make_extraction_node(llm: LLMProvider):
    system = (
        ...
        "فیلد confidence را بر اساس کیفیت مکالمه و وضوح اطلاعات تعیین کن: "
        "اگر مکالمه واضح و اطلاعات صریح بود نزدیک ۱، و اگر صدا نامفهوم یا اطلاعات مبهم بود "
        "پایین (زیر ۰٫۵). این عدد به کارشناس می‌گوید چقدر باید بازبینی کند."
    )
